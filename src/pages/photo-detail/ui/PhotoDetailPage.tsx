    ...
    <div className="flex min-h-dvh flex-col bg-bg-base">
      ...
      <main className="flex flex-col gap-5 px-5 pt-6 pb-10">
        ...
        <div className="flex items-center gap-4">
          ...
          <span className="typography-caption-medium shrink-0 text-text-subtle">0:45</span>
        ...
        <div className="pb-6">
          ...
          <div className="flex flex-col rounded-[16px] bg-white px-4 py-6 shadow-[0px_4px_20px_0px_rgba(0,0,0,0.04)]">
            ...
            <div className="pb-5">
              <span className="typography-body-sm-bold text-[#333333]">가족들의 반응</span>
            </div>
                ...
                <div key={id} className="flex gap-3">
                  ...
                  <div className="flex flex-1 flex-col gap-1">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="typography-body-xs-semibold text-text-primary">{author}</span>
                      <span className="typography-micro text-[#767676]">{time}</span>
                    </div>

                    {/* 말풍선 (19:494): bg:#FAFAFA, rounded-16px, px:12px py:11.56px */}
                    <div className="rounded-[16px] bg-[#FAFAFA] px-3 py-3">
                      <p className="typography-body-xs text-text-primary">{text}</p>
                    </div>
            ...
            <div className="flex items-center gap-3 pt-6">
              ...
              <input
                ...
                className="flex-1 bg-transparent py-1 typography-body-sm text-text-primary outline-none placeholder:text-[#C7C7CC]"
              />

              {/* 등록하기 버튼 (19:514): 70px, bg:#E5E7EB, rounded-10px */}
              <Button
                type="button"
                variant="gray"
