...
function NaverLogo() {
  ...
  return (
    <svg width="24" height="24" viewBox="3.5 3.5 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
...
export function SocialLoginButton({ variant, className, children, ...props }: SocialLoginButtonProps) {
  ...
  return (
    <button
      className={cn(
        'flex h-12 w-full items-center justify-center gap-2 rounded-lg transition-opacity cursor-pointer active:opacity-80 disabled:pointer-events-none disabled:opacity-40',
        bg,
        className,
      )}
      {...props}
